...
export class AddProject41700106485947 implements MigrationInterface {
    name = 'AddProject41700106485947'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "c_role" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, CONSTRAINT "PK_1874eaee054ae44ed2b8e0af9c4" PRIMARY KEY ("id"))`);
